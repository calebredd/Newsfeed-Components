...
class Article {
  constructor(articleData) {
    ...
    this.firstP = articleData["firstParagraph"];
    this.secondP = articleData["secondParagraph"];
    this.thirdP = articleData["thirdParagraph"];
    this.createElement();
  }
  ...
  createElement() {
    ...
    firstParagraph.textContent = this.firstP;
    secondParagraph.textContent = this.secondP;
    thirdParagraph.textContent = this.thirdP;
